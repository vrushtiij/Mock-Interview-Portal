...
import { Mic, MicOff, Send, CheckCircle, Star, Award, XCircle, HelpCircle } from "lucide-react";
...
const InterviewPage = () => {
  ...
  // Mark current question as visited when we navigate to it
  useEffect(() => {
    setVisitedQuestions(prev => new Set(prev).add(currentIndex));
  }, [currentIndex]);

  // Recalculate skip count based on visited questions with empty answers
  useEffect(() => {
        ...
        <div className="completion-screen">
          ...
          <div className="completion-stats">
            <div className="stat-card answered">
              <div className="stat-icon"><Award size={24} color="#4CAF50" /></div>
            ...
            <div className="stat-card skipped">
              <div className="stat-icon"><XCircle size={24} color="#f44336" /></div>
              <div className="stat-content">
                <h3>{skippedCount}</h3>
                <p>Skipped</p>
              </div>
            ...
            <div className="stat-card total">
              <div className="stat-icon"><HelpCircle size={24} color="#2196F3" /></div>
              <div className="stat-content">
          ...
          <div className="completion-message">
            <p>Thank you for completing the <strong>{selectedDomain}</strong> interview!</p>
            <p>Your responses have been submitted successfully and are under review.</p>
          </div>

          {/* Always show buttons regardless of isSubmitting */}
